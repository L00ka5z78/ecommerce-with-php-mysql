...
if (isset($_GET['edit_brands'])) {
    ...
    $get_brands            = "
        SELECT * FROM `brands` WHERE brand_id = $edit_brand
        ";
...
if (isset($_POST['edit_brand'])) {
    ...
    $update_query               = "
        UPDATE `brands` SET brand_title = '$brand_title'
...
<div class="container mt-3">
    ...
    <form action="" method="POST" class="text-center">
        <div class="form-outline mb-4 w-50 m-auto">
            ...
            <input type="text" class="form-control" name="brand_title" id="brand_title" required value="<?php echo $brand_title; ?>">
        </div>
