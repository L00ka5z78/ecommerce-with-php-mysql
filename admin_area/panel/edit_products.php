    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="form-outline w-50 m-auto mb-4">
            ...
            <div class="d-flex">
                ...
                <img class="product_img" src="./product_images/<?php echo $product_image1 ?>" alt="">
            </div>
        </div>
        <div class="form-outline w-50 m-auto mb-4">
            ...
            <div class="d-flex">
                ...
                <img class="product_img" src="./product_images/<?php echo $product_image2 ?>" alt="">
            </div>
        </div>
        <div class="form-outline w-50 m-auto mb-4">
            ...
            <div class="d-flex">
                ...
                <img class="product_img" src="./product_images/<?php echo $product_image3 ?>" alt="">
            </div>
        </div>
        <div class="form-outline w-50 m-auto mb-4">
...
if (isset($_POST['edit_product'])) {
    ...
    if (
        ...
        if ($result_update) {
            ...
            echo "<script>window.open('./panel/insert_product.php', '_self')</script>";
        }
    }
}
